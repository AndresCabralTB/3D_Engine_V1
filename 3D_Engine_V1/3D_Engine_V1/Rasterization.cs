...
namespace _3D_3ngine_V1
{
    public class Rasterization
    {
        ...
        public Rasterization(Size size, List<float[]> vertices, List<int[]> triangles, float rotateX, float rotateY, float rotateZ, float translateX, float translateY, float translateZ, float z)
        {
        ...
        private void Init(Size size, float z)
        {
            ...
            instances = new Instance(cube, new Vertex(3f, -2f, 30f), Mtx.Rotate(vert), z, Mtx.MakeTranslationMatrix(translate));
        ...
        public void Render(Vertex vert)
        {
        ...
        public void Render2(Vertex translateVertex)
        {
        ...
        public void RenderScene(Camera camera, Instance instances)
        {
            ...
            transform = cameraMatrix * instances.transform;
            clipped = TransformAndClip(camera.clipping_planes.ToArray(), instances.model, instances.scale, transform);
